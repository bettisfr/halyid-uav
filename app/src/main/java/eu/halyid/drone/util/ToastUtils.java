...
public class ToastUtils {
    ...
    private static void showMessage(Pair<TextView, String> msg) {
        if (msg != null) {
            if (msg.first == null) {
                Toast.makeText(DJISDKManager.getInstance().getContext(), "tv is null", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public static void showToast(String msg) {
        Toast.makeText(DJISDKManager.getInstance().getContext(), msg, Toast.LENGTH_SHORT).show();
    }
