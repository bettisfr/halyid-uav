...
import eu.halyid.drone.BuildConfig;
...
public class ConnectionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private SwitchCompat mSwitchDev;
...
//    }
    ...
    private void initUI() {
        ...
        mSwitchDev = findViewById(R.id.switch_dev);
        mSwitchDev.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mBtnEnter.setEnabled(isChecked);
            }
        });
    ...
    private void refreshSDKRelativeUI() {
        BaseProduct mProduct = DJIProcedures.getProductInstance();
    ...
    public void onClick(View v) {
        ...
        if (status != ConnectionResult.SUCCESS) {
            GoogleApiAvailability.getInstance().getErrorDialog(this, status, status);
